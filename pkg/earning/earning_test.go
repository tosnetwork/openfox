...
func TestEvaluatorHonorsNaturalLanguageStrategyDeclineBeforeProfit(t *testing.T) {
	...
	estimate := EconomicEstimate{
		StrategyDisposition:      EconomicStrategyDecline,
		StrategyRationale:        "avoid this counterparty",
		RevenueAtomic:            "1000",
		PaymentProbabilityPPM:    1_000_000,
		CompletionProbabilityPPM: 1_000_000,
		ComputeCostAtomic:        "1",
		MaximumLossAtomic:        "1",
	...
	if err != nil || decision.Eligible || decision.ExpectedNetAtomic != "999" ||
		decision.StrategyDisposition != EconomicStrategyDecline {
