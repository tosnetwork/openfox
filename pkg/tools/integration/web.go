...
const (
	...
	userAgentHonest = "openfox/%s (+https://github.com/tosnetwork/openfox; AI assistant bot)"
...
func (p *SearXNGSearchProvider) Search(
	...
	// Format results in standard OpenFox format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Retry once with an honest User-Agent that identifies openfox, which some
