...
func (t *A2ATaskTransport) Dispatch(ctx context.Context, transport atosbridge.Transport, task atosbridge.Task) error {
	if transport != atosbridge.TransportA2A {
...
var _ atosbridge.TaskTransport = (*A2ATaskTransport)(nil)
