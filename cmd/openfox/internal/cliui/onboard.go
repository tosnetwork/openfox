...
func printOnboardPlain(logo string, encrypt bool, configPath string) {
	...
	fmt.Println("\nNext steps:")
	if encrypt {
		fmt.Println("  1. Set your encryption passphrase before starting openfox:")
		fmt.Println("       export OPENFOX_KEY_PASSPHRASE=<your-passphrase>   # Linux/macOS")
		fmt.Println("       set OPENFOX_KEY_PASSPHRASE=<your-passphrase>      # Windows cmd")
		fmt.Println("")
	...
	fmt.Println("")
	if encrypt {
		fmt.Println("  3. Chat: openfox agent -m \"Hello!\"")
	} else {
		fmt.Println("  2. Chat: openfox agent -m \"Hello!\"")
	}
}
...
func printOnboardFancy(logo string, encrypt bool, configPath string) {
	...
	ready := titleBarStyle().Render(logo+" openfox is ready!") + "\n"
	fmt.Println()
...
func buildOnboardingSteps(encrypt bool, configPath string) string {
	...
	if encrypt {
		b.WriteString("1. Set your encryption passphrase before starting openfox:\n")
		b.WriteString("   export OPENFOX_KEY_PASSPHRASE=<your-passphrase>   # Linux/macOS\n")
		b.WriteString("   set OPENFOX_KEY_PASSPHRASE=<your-passphrase>      # Windows cmd\n\n")
