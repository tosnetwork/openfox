...
var (
	ErrPolicyInvalid        = errors.New("atosbridge: owner spending policy is invalid or unsigned")
	ErrPolicyExpired        = errors.New("atosbridge: owner spending policy has expired")
	ErrAssetNotAllowed      = errors.New("atosbridge: quote asset does not match the policy asset identity")
	ErrCapabilityNotAllowed = errors.New("atosbridge: capability is not on the owner allow-list")
	ErrOverPurchaseLimit    = errors.New("atosbridge: quote amount exceeds the per-purchase limit")
	ErrOverDailyBudget      = errors.New("atosbridge: quote amount exceeds the remaining windowed budget")
	ErrManualConfirmation   = errors.New("atosbridge: policy requires manual owner confirmation")
)
