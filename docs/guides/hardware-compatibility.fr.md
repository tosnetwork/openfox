...
# 🖥️ OpenFox Liste de compatibilité matérielle

OpenFox fonctionne sur pratiquement n'importe quel appareil Linux. Cette page répertorie les puces, produits et cartes de développement vérifiés.
...
Produits grand public, routeurs et appareils industriels testés avec OpenFox.
...
| 2026 | MaixCAM2 | ARM64 (A53) | AX630C | 1/4GB | Caméra AI 4K |
...
Tout téléphone Android ARM64 (2015+) avec 1 Go+ de RAM. Installez [Termux](https://github.com/termux/termux-app), utilisez `proot` pour exécuter OpenFox.
