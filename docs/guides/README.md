...
Task-oriented guides for setup, configuration, and common OpenFox workflows.

- [Docker & Quick Start Guide](docker.md): install and run OpenFox with Docker or the launcher.
- [Android Termux Guide](android-termux.md): run the OpenFox terminal binary on an ARM64 Android phone.
