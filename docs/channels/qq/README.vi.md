...
OpenFox hỗ trợ QQ thông qua API Bot chính thức của Nền tảng Mở QQ.
...
3. Điền thông tin xác thực vào file cấu hình OpenFox
4. Chạy `openfox gateway` để khởi động dịch vụ
...
4. Điền thông tin xác thực vào file cấu hình OpenFox
5. Chạy `openfox gateway` để khởi động dịch vụ
