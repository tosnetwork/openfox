...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open OpenFox console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About OpenFox",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit OpenFox",
		Exiting:            "Exiting OpenFox...",
		DocUrl:             "https://docs.openfox.im/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 OpenFox 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 OpenFox",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 OpenFox",
		Exiting:            "正在退出 OpenFox...",
		DocUrl:             "https://docs.openfox.im/zh-Hans/docs/",
	},
}
