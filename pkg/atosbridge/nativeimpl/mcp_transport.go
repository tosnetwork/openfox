...
func (t *MCPTaskTransport) Dispatch(ctx context.Context, transport atosbridge.Transport, task atosbridge.Task) error {
	if transport != atosbridge.TransportMCP {
...
var _ atosbridge.TaskTransport = (*MCPTaskTransport)(nil)
