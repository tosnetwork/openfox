module github.com/tosnetwork/openfox/pkg/servicebridge/nativeimpl
...
require (
	...
	github.com/containerd/containerd/v2 v2.0.11 // indirect
...
replace github.com/tosnetwork/tos-service-protocol => ../../../../tos-service-protocol
