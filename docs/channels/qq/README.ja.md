...
OpenFox は QQ オープンプラットフォームの公式 Bot API を通じて QQ をサポートします。
...
3. OpenFox 設定ファイルに認証情報を入力する
4. `openfox gateway` を実行してサービスを起動する
...
4. OpenFox 設定ファイルに認証情報を入力する
5. `openfox gateway` を実行してサービスを起動する
