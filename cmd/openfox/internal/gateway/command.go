...
import (
	...
	"github.com/tosnetwork/openfox/pkg/gateway"
...
func NewGatewayCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			return gateway.Run(debug, internal.GetOpenfoxHome(), internal.GetConfigPath(), allowEmpty)
		},
	}
