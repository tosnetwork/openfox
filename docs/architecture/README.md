...
- [Capability Boundary and Core Decomposition](capability-boundary.md): which subsystems stay in the binary, which move to Skills, local hermetic MCP or separate binaries, why remote MCP is closed to this runtime today, and how PredictionMarket should be split across them.
