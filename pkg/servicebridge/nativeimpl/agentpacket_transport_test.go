...
func TestAgentPacketTransportSignsAndPosts(t *testing.T) {
	...
	if err := transport.Dispatch(context.Background(), servicebridge.TransportAgentPacket, sampleTask()); err != nil {
...
func TestAgentPacketTransportRejectsUnboundTask(t *testing.T) {
	...
	if err := transport.Dispatch(context.Background(), servicebridge.TransportAgentPacket, task); err == nil {
