...
func TestVerifySettlementReleased(t *testing.T) {
	...
	s, err := r.VerifySettlement(context.Background(), atosbridge.AcceptedQuote{EscrowAddress: "0:" + hex64})
	if err != nil {
...
func TestVerifySettlementRequiresEscrowAddress(t *testing.T) {
	...
	if _, err := r.VerifySettlement(context.Background(), atosbridge.AcceptedQuote{}); err == nil {
