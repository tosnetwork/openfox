...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.openfox")
	assert.Equal(t, "/home/user/.openfox/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.openfox/workspace/file.txt", "/home/user/.openfox")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".openfox"), result)
}
