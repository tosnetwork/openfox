...
*Our defining characteristic. We fight software bloat to ensure OpenFox runs smoothly on the smallest embedded devices.*

* [**Memory Footprint Reduction**](https://github.com/tosnetwork/openfox/issues/346) 
...
* **Provider**
  * [**Architecture Upgrade**](https://github.com/tosnetwork/openfox/issues/283): Refactor from "Vendor-based" to "Protocol-based" classification (e.g., OpenAI-compatible, Ollama-compatible). *(Status: In progress by @Daming, ETA 5 days)*
...
* **Skill Marketplace**
  * [**Discovery skills**](https://github.com/tosnetwork/openfox/issues/287): Implement `find_skill` to automatically discover and install skills from the [GitHub Skills Repo] or other registries.
...
* **Operations**
  * [**MCP Support**](https://github.com/tosnetwork/openfox/issues/290): Native support for the **Model Context Protocol (MCP)**.
  * [**Browser Automation**](https://github.com/tosnetwork/openfox/issues/293): Headless browser control via CDP (Chrome DevTools Protocol) or ActionBook.
  * [**Mobile Operation**](https://github.com/tosnetwork/openfox/issues/292): Android device control (similar to BotDrop).


* **Multi-Agent Collaboration**
  * [**Basic Multi-Agent**](https://github.com/tosnetwork/openfox/issues/294) implement
  * [**Model Routing**](https://github.com/tosnetwork/openfox/issues/295): "Smart Routing" — dispatch simple tasks to small/local models (fast/cheap) and complex tasks to SOTA models (smart).
  * [**Swarm Mode**](https://github.com/tosnetwork/openfox/issues/284): Collaboration between multiple OpenFox instances on the same network.
  * [**AIEOS**](https://github.com/tosnetwork/openfox/issues/296): Exploring AI-Native Operating System interaction paradigms.
...
* [**QuickGuide (Zero-Config Start)**](https://github.com/tosnetwork/openfox/issues/350)
...
* [**Logo Design**](https://github.com/tosnetwork/openfox/issues/297): We are looking for a **Mantis Shrimp (Stomatopoda)** logo design!
