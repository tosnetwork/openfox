...
func DefaultConfig() *Config {
	...
	return &Config{
		...
		Earning: EarningSettings{Enabled: false, Mode: "off", ObserveOnly: true, MinimumIndependentCarriers: 2,
			IntervalSeconds: 300, JitterSeconds: 30, CycleTimeoutSeconds: 60,
			Acquisition: EarningAcquisitionSettings{ShortlistSize: 40, MaximumPerIssuer: 3, MaximumPerSource: 20,
				MaximumPerTaxonomy: 12, MaximumPerValueBand: 12, ExplorationPercent: 10},
			Publication: EarningPublicationSettings{NetworkID: "tos:mainnet", AllowDemand: true, AllowedAudiences: []string{"public:indexable"}, MinimumTTLSeconds: 3600,
				MaximumTTLSeconds: 604800, MinimumMarginPPM: 300000, MaximumPriceChangePPM: 250000,
				MaximumActive: 5, MaximumRevisionsPerObject: 3, MaximumPublicationsPerPeriod: 2, PeriodSeconds: 86400},
			Retrieval: EarningRetrievalSettings{MaximumConnections: 4, MaximumResponseHeaderBytes: 64 << 10,
				MaximumCompressedBytes: 8 << 20, MaximumDecodedBytes: 64 << 20, TimeoutMillis: 15_000},
			Gates: EarningGateSettings{}, Policy: EarningPolicySettings{MinimumExpectedProfitAtomic: "0", MaximumLossAtomic: "0", MaximumOutgoingPaymentAtomic: "0"}},
