...
import (
	...
	"github.com/tosnetwork/openfox/pkg/channels/weixin"
...
to authorize your account. On success, the bot token is saved to the openfox
...
func printManualWeixinConfig(token, baseURL string) {
	fmt.Println()
	fmt.Println("Add the following to the channels section of your openfox config:")
	fmt.Println()
	fmt.Println(`  "weixin": {`)
