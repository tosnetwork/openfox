...
func sampleTask() atosbridge.Task {
	return atosbridge.Task{
...
func TestA2ATransportDispatchesCompletedTask(t *testing.T) {
	...
	if err := transport.Dispatch(context.Background(), atosbridge.TransportA2A, sampleTask()); err != nil {
...
func TestA2ATransportRejectsUnboundTask(t *testing.T) {
	...
	if err := transport.Dispatch(context.Background(), atosbridge.TransportA2A, task); err == nil {
